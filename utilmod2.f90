...
interface  dumpm
   ...
   module procedure dumpv_I     ! print integer  vector
   module procedure dumpv2_I     
   module procedure dumpv_d     ! print  real vector
...
contains 
  !@
  !@  dump  vector  A, integer 
  !@
  subroutine   dumpv_I(A) 
    integer :: i,i0,i1,N 
    integer, dimension(:) :: A
    N=size(A)
    100 format (100(I6,' '))
   ...
   !write(*,*)  'size', size(A)
  end subroutine   dumpv_I 

  !@
  !@  dump  vector  A, integer 
  !@
  subroutine   dumpv2_I(A,M) 
    integer :: i,i0,i1,N,M
    integer, dimension(:) :: A
    N=size(A)
    100 format (100(I6,' '))
    i0 = lbound(A,1)  ; i1 = min(M,ubound(A,1))
    write(*,100) (A(i),i=i0,i1) 
   !write(*,*)  'size', size(A)
  end subroutine   dumpv2_I 
